    ...
    <div>
        <span class="rounded-md shadow-sm">
            <button @click="open = !open" type="button"
                {{ $attributes->merge(["class" => "inline-flex justify-center w-full rounded-md border border-gray-200 px-4 py-2 bg-white text-sm leading-5
                font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue
