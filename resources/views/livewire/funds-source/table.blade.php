<div>
    <div class="-mx-4 my-10 shadow bg-white sm:-mx-6 md:mx-0 md:rounded-lg">
            ...
            <div class="w-96">
                ...
                <div class="relative text-gray-500 focus-within:text-gray-600">
                    ...
                    <input wire:model.debounce.500ms="search"
                        ...
                        placeholder="Cari sumber dana..." type="search">
                </div>
            </div>
            <div class="flex items-center space-x-2">
                <x-button.primary onclick="Livewire.emit('openModal', 'funds-source.create')"
        ...
        <x-table>
            ...
            <x-slot name="body">
                @forelse ($fundsSources as $funds)
                    <tr wire:key="funds-{{ $funds->id }}" wire:loading.class.delay="opacity-50">
                        <td
                        ...
                        <td
                            ...
                            @include('livewire.funds-source._actions')
                            @if (!$loop->first)
