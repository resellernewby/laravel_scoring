<div class="flex items-center justify-end space-x-4">
    <x-button.primary link="{{ route('consumable.checkin') }}" class="flex whitespace-nowrap items-center bg py-1">
        <x-icon.plus class="h-4 w-4 mr-1" /> Keranjang
    </x-button.primary>
    <x-dropdown label="Opsi" class="py-1" wire:key="actions-{{ $consumable->id }}">
